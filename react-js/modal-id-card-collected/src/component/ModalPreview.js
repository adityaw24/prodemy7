              ...
              <Col sm={8} className="bg-light p-3">
                <Row>
                  <Col sm={12} className="mb-4 text-center">
                    <h5 className="fw-bold mb-2">{props.user.nama}</h5>
                    <p className="mb-0">{props.user.job}</p>
                  </Col>
                  <Col sm={4} className="mb-3">
                    <p className="mb-0">Birthdate</p>
                  </Col>
                  <Col sm={8} className="mb-3">
                    <p className="mb-0">: {props.user.tanggalLahir}</p>
                  </Col>
                  <Col sm={4} className="mb-3">
                    <p className="mb-0">Gender</p>
                  </Col>
                  <Col sm={8} className="mb-3">
                    <p className="mb-0">: {props.user.gender}</p>
                  </Col>
                  <Col sm={4} className="mb-3">
                    <p className="mb-0">Religion</p>
                  </Col>
                  <Col sm={8} className="mb-3">
                    <p className="mb-0">: {props.user.agama}</p>
                  </Col>
                  <Col sm={4} className="mb-3">
                    <p className="mb-0">Phone Number</p>
                  </Col>
                  <Col sm={8} className="mb-3">
                    <p className="mb-0">: {props.user.kontak}</p>
                  </Col>
                  <Col sm={4} className="mb-3">
